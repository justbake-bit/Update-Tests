...
namespace MHLab.Patch.Core.Admin
{
    public interface IAdminSettings : ISettings
    {
        ...
        string GetBuildsIndexPath();
        string GetPatchesFolderPath();
        string GetPatchesTempFolderPath();
        string GetPatchIndexPath(IVersion from, IVersion to);
        string GetPatchesIndexPath();
        string GetBuildDefinitionPath(IVersion version);
        string GetGameFolderPath(IVersion version);
        string GetVersionFilePath(IVersion version);
        string GetUpdaterFolderPath();
        string GetUpdaterIndexPath();
    ...
    public class AdminSettings : Settings, IAdminSettings
    {
        ...
        public virtual string GetBuildsIndexPath() => PathsManager.Combine(RootPath, BuildsFolderName, BuildsIndexFileName);
        public virtual string GetPatchesFolderPath() => PathsManager.Combine(RootPath, PatchesFolderName);
        public virtual string GetPatchesTempFolderPath() => PathsManager.Combine(RootPath, PatchesFolderName, TempFolderName);
